...
function Head() {
  ...
  return (
    <div
      className="min-h-screen pt-24 pb-10 lg:pt-40 lg:pb-28 flex justify-center items-center"
      style={{ background: `url(${imgSrc})`, backgroundSize: "cover" }}
    >
      <div className="container px-5 lg:px-10 flex flex-col lg:flex-row justify-between items-center gap-12">
        <div className="max-w-xs md:max-w-xl flex flex-col gap-6 xl:gap-10 items-center lg:items-start">
          <h1 className="text-3xl sm:text-5xl lg:text-[2.75rem] text-center lg:text-left font-bold text-primary leading-[3.5rem]">
